...
exports.GerencialController = GerencialController;
...
async function GerencialController(req, res) {
  ...
  if (errors.length > 0) {
    ...
    (async function () {
      try {
        ...
        const content = await compile("pdfgerencial", datta); // console.log(content);
      ...
      try {
        _Email.default.SolicitudGerencial(req, res);
      } catch (e) {
        console.log(e);
      }
    })(); //   }
